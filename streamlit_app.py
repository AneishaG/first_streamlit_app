...
# write your own comment -what does the next line do? IT should return what fruit is actually selected and normalize it that way?
...
#this will not work correctly but we are going with it for now
